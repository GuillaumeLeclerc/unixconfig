...
hi StatusLineNC guifg=#a9a9a9 guibg=NONE guisp=NONE gui=NONE ctermfg=248 ctermbg=NONE cterm=NONE
...
hi ErrorMsg guifg=#8b0000 guibg=#a9a9a9 guisp=#a9a9a9 gui=NONE ctermfg=88 ctermbg=248 cterm=NONE
hi Ignore guifg=#bebebe guibg=#a9a9a9 guisp=#a9a9a9 gui=NONE ctermfg=7 ctermbg=248 cterm=NONE
...
hi StatusLine guifg=#bebebe guibg=NONE guisp=NONE gui=NONE ctermfg=7 ctermbg=NONE cterm=NONE
...
hi Error guifg=#8b0000 guibg=#a9a9a9 guisp=#a9a9a9 gui=NONE ctermfg=88 ctermbg=248 cterm=NONE
...
hi pmenum guifg=#6f27ff guibg=#0a001c guisp=#0a001c gui=NONE ctermfg=57 ctermbg=17 cterm=NONE
hi cursor guifg=#ffffff guibg=#cc4455 guisp=#cc4455 gui=NONE ctermfg=15 ctermbg=167 cterm=NONE
hi sql_statement guifg=#3d27ff guibg=NONE guisp=NONE gui=NONE ctermfg=21 ctermbg=NONE cterm=NONE
hi cics_statement guifg=#ffd631 guibg=NONE guisp=NONE gui=NONE ctermfg=221 ctermbg=NONE cterm=NONE
hi namespace guifg=#006400 guibg=NONE guisp=NONE gui=NONE ctermfg=22 ctermbg=NONE cterm=NONE
hi builtin guifg=#47ffc5 guibg=NONE guisp=NONE gui=NONE ctermfg=86 ctermbg=NONE cterm=NONE
...
hi foldecolumn guifg=#6f27ff guibg=#0c1020 guisp=#0c1020 gui=NONE ctermfg=57 ctermbg=234 cterm=NONE
...
hi cppstltype guifg=#b3fff5 guibg=NONE guisp=NONE gui=NONE ctermfg=159 ctermbg=NONE cterm=NONE
...
hi javascriptconditional guifg=#ff27b7 guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi xmlattribpunct guifg=#fffffc guibg=NONE guisp=NONE gui=NONE ctermfg=230 ctermbg=NONE cterm=NONE
hi javascriptfunction guifg=#c227ff guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi javascriptregexpstring guifg=#ff272b guibg=NONE guisp=NONE gui=NONE ctermfg=196 ctermbg=NONE cterm=NONE
hi pythondoctest2 guifg=#3b916a guibg=NONE guisp=NONE gui=NONE ctermfg=72 ctermbg=NONE cterm=NONE
hi rubystring guifg=#27ffc2 guibg=NONE guisp=NONE gui=NONE ctermfg=49 ctermbg=NONE cterm=NONE
hi rubyindentifier guifg=#27ffc2 guibg=NONE guisp=NONE gui=NONE ctermfg=49 ctermbg=NONE cterm=NONE
hi rubydata guifg=#6f27ff guibg=NONE guisp=NONE gui=NONE ctermfg=57 ctermbg=NONE cterm=NONE
hi jinjaraw guifg=#aaaaaa guibg=#fbf4c7 guisp=#fbf4c7 gui=NONE ctermfg=248 ctermbg=230 cterm=NONE
hi rubyspaceerror guifg=NONE guibg=#27051b guisp=#27051b gui=NONE ctermfg=NONE ctermbg=53 cterm=NONE
hi javascriptdomelemfuncs guifg=#e2ffa9 guibg=NONE guisp=NONE gui=NONE ctermfg=193 ctermbg=NONE cterm=NONE
hi erubyrubydelim guifg=#d9ff50 guibg=NONE guisp=NONE gui=NONE ctermfg=191 ctermbg=NONE cterm=NONE
hi erubycomment guifg=#f7ff87 guibg=NONE guisp=NONE gui=NONE ctermfg=228 ctermbg=NONE cterm=NONE
hi djangostatement guifg=#005f00 guibg=#ddffaa guisp=#ddffaa gui=NONE ctermfg=22 ctermbg=193 cterm=NONE
hi javascriptlabel guifg=#27ffa1 guibg=NONE guisp=NONE gui=NONE ctermfg=48 ctermbg=NONE cterm=NONE
hi jinjaoperator guifg=#ffffff guibg=#fbf4c7 guisp=#fbf4c7 gui=NONE ctermfg=15 ctermbg=230 cterm=NONE
hi rubykeyword guifg=#b7ff27 guibg=NONE guisp=NONE gui=NONE ctermfg=154 ctermbg=NONE cterm=NONE
hi jinjavarblock guifg=#ff0007 guibg=#fbf4c7 guisp=#fbf4c7 gui=NONE ctermfg=196 ctermbg=230 cterm=NONE
hi javascripthtmlelemfuncs guifg=#ff272b guibg=NONE guisp=NONE gui=NONE ctermfg=196 ctermbg=NONE cterm=NONE
...
hi djangovarblock guifg=#ff27b7 guibg=#1c0c20 guisp=#1c0c20 gui=NONE ctermfg=13 ctermbg=234 cterm=NONE
hi javascriptcssstyles guifg=#ff272b guibg=NONE guisp=NONE gui=NONE ctermfg=196 ctermbg=NONE cterm=NONE
hi jinjastring guifg=#0086d2 guibg=#fbf4c7 guisp=#fbf4c7 gui=NONE ctermfg=32 ctermbg=230 cterm=NONE
hi javascriptrepeat guifg=#ff27b7 guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
...
hi djangoargument guifg=#27ffc2 guibg=#1c0c20 guisp=#1c0c20 gui=NONE ctermfg=49 ctermbg=234 cterm=NONE
...
hi djangocomment guifg=#b7ff27 guibg=#192305 guisp=#192305 gui=NONE ctermfg=154 ctermbg=58 cterm=NONE
...
hi javascriptdoccomment guifg=#6f27ff guibg=NONE guisp=NONE gui=NONE ctermfg=57 ctermbg=NONE cterm=NONE
hi xmlnamespace guifg=#27ffa1 guibg=NONE guisp=NONE gui=NONE ctermfg=48 ctermbg=NONE cterm=NONE
hi xmltag guifg=#F8BB00 guibg=NONE guisp=NONE gui=NONE ctermfg=214 ctermbg=NONE cterm=NONE
hi htmlevent guifg=#6f27ff guibg=NONE guisp=NONE gui=NONE ctermfg=57 ctermbg=NONE cterm=NONE
hi jinjastatement guifg=#fb660a guibg=#fbf4c7 guisp=#fbf4c7 gui=NONE ctermfg=202 ctermbg=230 cterm=NONE
hi xmlcdataend guifg=#ff36fc guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi pythonbuiltinfunc guifg=#2b6ba2 guibg=NONE guisp=NONE gui=NONE ctermfg=25 ctermbg=NONE cterm=NONE
hi xmlequal guifg=#fffffc guibg=NONE guisp=NONE gui=NONE ctermfg=230 ctermbg=NONE cterm=NONE
...
hi javascriptprototype guifg=#27ffa1 guibg=NONE guisp=NONE gui=NONE ctermfg=48 ctermbg=NONE cterm=NONE
hi pythonclass guifg=#ff0086 guibg=NONE guisp=NONE gui=NONE ctermfg=198 ctermbg=NONE cterm=NONE
hi xmlcdata guifg=#ff36fc guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
...
hi djangotagblock guifg=#ff27b7 guibg=#1c0c20 guisp=#1c0c20 gui=NONE ctermfg=13 ctermbg=234 cterm=NONE
hi jinjaspecial guifg=#008ffd guibg=#fbf4c7 guisp=#fbf4c7 gui=NONE ctermfg=33 ctermbg=230 cterm=NONE
hi xmlcdatacdata guifg=#fc47ff guibg=#210923 guisp=#210923 gui=NONE ctermfg=13 ctermbg=235 cterm=NONE
hi xmlcdatastart guifg=#ff36fc guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi rubydocumentation guifg=#ffffff guibg=#a9a9a9 guisp=#a9a9a9 gui=NONE ctermfg=15 ctermbg=248 cterm=NONE
hi djangofilter guifg=#c227ff guibg=#1c0c20 guisp=#1c0c20 gui=NONE ctermfg=13 ctermbg=234 cterm=NONE
...
hi mydiffsubname guifg=#27ff6f guibg=NONE guisp=NONE gui=NONE ctermfg=47 ctermbg=NONE cterm=NONE
hi mydiffcommline guifg=#6f27ff guibg=#8b1965 guisp=#8b1965 gui=NONE ctermfg=57 ctermbg=89 cterm=NONE
hi mailqu guifg=#b7ff27 guibg=#000000 guisp=#000000 gui=NONE ctermfg=154 ctermbg=NONE cterm=NONE
hi mydiffnew guifg=#ff27b7 guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi mydiffremoved guifg=#ff27b7 guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi mydiffnormal guifg=#6f27ff guibg=#6f27ff guisp=#6f27ff gui=NONE ctermfg=57 ctermbg=57 cterm=NONE
...
hi mailq guifg=#27ff6f guibg=#000000 guisp=#000000 gui=NONE ctermfg=47 ctermbg=NONE cterm=NONE
